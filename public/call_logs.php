    ...
    <body >
        ...
        <div align="center">
            ...
            <TABLE class='t1 navbar-default' style="margin-top: 20px">
                <tr><th style="font-size: 18px"><a href="contacts.php">Contacts</a></th><th><a href="messages.php">Messages</a></th><th style="background-color: #7b7b83"><a href="call_logs.php">Call Logs</a></th><th><a href="apps.php">Installed Apps</a></th></tr>
            </table>
...
/////////////// Total number of records in our table. We will use this to break the pages///////
            $nume = $dbo->query("select count(id) from call_logs WHERE uId = '$email'")->fetchColumn();
/////// The variable nume above will store the total number of records in the table////
/////////// Now let us print the table headers ////////////////

            $sql = "SELECT * FROM call_logs WHERE uId = '$email' ORDER BY id ASC LIMIT $eu, $limit";
            $rs_result = mysqli_query($conn, $sql);
            ?>
            <?php
            echo "<TABLE class='t1 navbar-default' style='margin-top: 20px; margin-bottom: 10px'>";
            echo "<tr><th class='w3-hide-small w3-hide-medium'>ID</th><th>Name</th><th>Phone No.</th><th>Call Type</th><th>Call Time</th><th class='w3-hide-small w3-hide-medium'>Duration (in_Secs)</th><th class='w3-hide-small w3-hide-medium'>Country</th><th>X</th></tr>";
...
//while ($row = mysqli_fetch_assoc($rs_result)) {
            foreach ($dbo->query($sql) as $row) {
                ...
                <td class="w3-hide-small w3-hide-medium"><?php echo $call_duration; ?></td>
                <td class="w3-hide-small w3-hide-medium"><?php echo $country; ?></td>
                <td><a href="delete_call_log.php?id=<?php echo $id ?>&imei=<?php echo $imei ?>"><button class="btn-danger">X</button></a>
